...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &AddUserForm::panel1_Paint);
			// 
			// button1
			// 
			...
			this->pnPosition->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->cbPosition->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pnBirthday->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pnSex->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->cbSex->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pnNameStaff->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->txtNameStaff->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pnPass->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->txtAddPass->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->pnAddAccount->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->txtAddAccount->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->flowLayoutPanel1->Padding = System::Windows::Forms::Padding(2, 2, 2, 2);
